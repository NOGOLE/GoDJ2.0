...
<h2>Make Your Requests Known</h2>
  ...
  <input  ng-click="submitSong() row col-xs-" type="submit"  value="Submit Request" class="btn btn-primary">
</form>
</div>
...
<form  class="request_form">
  ...
  <input  ng-click="submitMood() row col-xs-" type="submit" value="Submit Request" class="btn btn-primary">
</form>	
		</div>
</div>	
</div>
